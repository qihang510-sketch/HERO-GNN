...
def _diagnostic_columns() -> list[str]:
    return [
        ...
        "branch_mask_chain",
        "pred_positive_rate",
        "pred_positive_rate_at_05",
        "best_threshold",
        "threshold_search_mode",
        "val_best_macro_f1",
        "val_pred_positive_rate_at_best_threshold",
        "macro_f1_at_05",
        "mean_pred_prob_pos",
        "mean_pred_prob_neg",
        "std_pred_prob",
        "min_pred_prob",
        "max_pred_prob",
        "num_homophilic_neighbors_used",
        "num_heterophilic_neighbors_used",
        "num_chains_used",
        "num_mechanism_labels_used",
        "num_raw_chains",
        "num_filtered_chains",
        "chain_filter_keep_rate",
        "avg_chain_quality",
        "avg_chain_quality_pos",
        "avg_chain_quality_neg",
        "avg_chain_gate",
        "avg_chain_gate_pos",
        "avg_chain_gate_neg",
        "avg_homo_gate",
        ...
        "delta_zero_hetero",
        "delta_zero_chain",
        "delta_zero_mechanism",
        "lambda_chain_pos",
        "chain_pos_loss",
        "avg_full_prob_pos",
        "avg_no_chain_prob_pos",
        "avg_full_prob_neg",
        "avg_no_chain_prob_neg",
        "tn",
        "fp",
        "fn",
        "tp",
